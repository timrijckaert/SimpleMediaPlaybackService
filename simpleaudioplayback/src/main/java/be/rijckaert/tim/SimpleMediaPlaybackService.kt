...
class SimpleMediaPlaybackService : MediaBrowserServiceCompat(), AudioManager.OnAudioFocusChangeListener {
                        ...
                        .apply {
                            setActions(
                                    when {
                                        ...
                                        else      -> ACTION_PLAY_PAUSE or PlaybackStateCompat.ACTION_PLAY
                                    }
                            )
                        }.build()
        )
    ...
    override fun onCreate() {
        ...
        mediaSession = MediaSessionCompat(
            ...
            setPlaybackState(Builder().setActions(PlaybackStateCompat.ACTION_PLAY or ACTION_PLAY_PAUSE).build())
